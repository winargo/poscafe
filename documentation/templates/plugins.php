<div class="card">
    <div class="header">
        <h2>
            PLUGINS
            <small>AdminBSB - Material Design used of the following plugins. For documentation, updates or license information, please visit the links below.</small>
        </h2>
    </div>
    <div class="body">
        <div class="row clearfix">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="http://ionden.com/a/plugins/ion.rangeSlider/en.php" target="_blank">ionRangeSlider</a></li>
