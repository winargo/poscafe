...
<head>
    ...
    <title>Range Sliders | Bootstrap Based Admin Template - Material Design</title>
    <!-- Favicon-->
...
<body class="theme-red">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                EXAMPLES
                                <small>Taken by Ion Range Slider which link is <a href="http://ionden.com/a/plugins/ion.rangeSlider/en.php" target="_blank">ionden.com/a/plugins/ion.rangeSlider/en.php</a></small>
                            </h2>
    ...
    <script src="../../js/pages/ui/range-sliders.js"></script>
