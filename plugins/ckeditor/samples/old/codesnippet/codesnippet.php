...
<body>
	<h1 class="samples">
		<a href="../../../samples/old/index.php">CKEditor Samples</a> &raquo; Code Snippet Plugin
	</h1>
	<div class="warning deprecated">
		This sample is not maintained anymore. Check out its <a href="http://sdk.ckeditor.com/samples/codesnippet.php">brand new version in CKEditor SDK</a>.
	</div>
	...
	<div class="description">
		...
		<p>
			...
			(see <a href="http://highlightjs.org/static/test.php">available themes</a>).
		</p>
		<p>
...
CKEDITOR.inline( 'editable', {
	<strong>extraPlugins: 'codesnippet'</strong>
		...
		<p>
			<strong>Note</strong>: The <a href="http://highlightjs.org/static/test.php">highlight.js themes</a>
