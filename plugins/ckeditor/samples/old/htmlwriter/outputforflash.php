...
<body>
	<h1 class="samples">
		<a href="../../../samples/old/index.php">CKEditor Samples</a> &raquo; Producing Flash Compliant HTML Output
	</h1>
	...
	<div class="description">
		<p>
			...
			<a class="samples" href="http://www.adobe.com/livedocs/flash/9.0/main/wwhelp/wwhimpl/common/html/wwhelp.htm?context=LiveDocs_Parts&amp;file=00000922.php">
			Adobe Flash</a>.
				...
				<script>
					...
					function configureFlashOutput( ev ) {
						var editor = ev.editor,
							...
							htmlFilter = dataProcessor && dataProcessor.phpFilter;
