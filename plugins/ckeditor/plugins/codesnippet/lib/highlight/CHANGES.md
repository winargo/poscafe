...
[cr]: http://highlightjs.readthedocs.org/en/latest/css-classes-reference.php
[api docs]: http://highlightjs.readthedocs.org/en/latest/api.php
...
[amd]: http://requirejs.org/docs/whyamd.php
...
[pojoaque]: http://web-cms-designs.com/ftopict-10-pojoaque-style-for-highlight-js-code-highlighter.php
...
Also test.php now shows the second best result of language detection by
relevance.
...
Test file test.php has at last become a real test. Now it not only puts the
...
File export.php contains a little program that shows and allows to copy and
