   ...
   Plugin.prototype =
           {
              ...
              initDate: function (d)
              {
                 ...
                 if (typeof (_calendar.week) !== 'undefined' && typeof (_calendar.days) !== 'undefined')
                 {
                    ...
                    this.$dtpElement.find('.dtp-picker-calendar').php(_template);
              ...
              showDate: function (date)
              {
                 if (date)
                 {
                    this.$dtpElement.find('.dtp-actual-day').php(date.locale(this.params.lang).format('dddd'));
                    this.$dtpElement.find('.dtp-actual-month').php(date.locale(this.params.lang).format('MMM').toUpperCase());
                    this.$dtpElement.find('.dtp-actual-num').php(date.locale(this.params.lang).format('DD'));
                    this.$dtpElement.find('.dtp-actual-year').php(date.locale(this.params.lang).format('YYYY'));
                 }
              },
              showTime: function (date)
              {
                 if (date)
                 {
                    ...
                    if (this.params.date)
                       this.$dtpElement.find('.dtp-actual-time').php(content);
                    else
                    {
                       if (this.params.shortTime)
                          this.$dtpElement.find('.dtp-actual-day').php(date.format('A'));
                       else
                          this.$dtpElement.find('.dtp-actual-day').php('&nbsp;');

                       this.$dtpElement.find('.dtp-actual-maxtime').php(content);
                    }
                 }
              },
