...
<head>
    ...
    <title>Badges | Bootstrap Based Admin Template - Material Design</title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!-- #END# Tasks -->
                    <li><a href="javascript:void(0);" class="js-right-sidebar"><i class="material-icons">more_vert</i></a></li>
                </ul>
            </div>
        </div>
    </nav>
